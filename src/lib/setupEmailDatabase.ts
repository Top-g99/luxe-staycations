...
async function createEmailConfigurationsTable(): Promise<void> {
  ...
  if (error) {
    console.log('Email configurations table may already exist or error occurred:', error);
  }
}
...
async function createEmailTemplatesTable(): Promise<void> {
  ...
  if (error) {
    console.log('Email templates table may already exist or error occurred:', error);
  }
}
...
async function createEmailTriggersTable(): Promise<void> {
  ...
  if (error) {
    console.log('Email triggers table may already exist or error occurred:', error);
  }
}
...
async function createEmailLogsTable(): Promise<void> {
  ...
  if (error) {
    console.log('Email logs table may already exist or error occurred:', error);
  }
}
