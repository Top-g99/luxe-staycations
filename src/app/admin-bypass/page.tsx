    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="h3" component="h1" gutterBottom>
          🚀 Luxe Staycations Admin Dashboard (Bypass Mode)
        </Typography>
        <Typography variant="subtitle1" color="text.secondary">
          Direct access to admin panel - No authentication required
        </Typography>
        <Alert severity="info" sx={{ mt: 2 }}>
          This is a bypass mode for testing. In production, use the secure login at /admin/login
        </Alert>
      </Box>
      ...
      <Box sx={{ mt: 4, textAlign: 'center' }}>
        <Typography variant="body2" color="text.secondary">
          Luxe Staycations Admin Dashboard v1.0 (Bypass Mode)
        </Typography>
        <Button
          variant="outlined"
