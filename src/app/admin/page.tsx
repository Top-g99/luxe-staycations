...
export default function AdminDashboard() {
  ...
  const loadDashboardData = () => {
    try {
      ...
      const featuredDestinations = destinationManager.getFeaturedDestinations();
      
      // Load callbacks
      const callbacks = callbackManager.getAllCallbacks();
      const pendingCallbacks = callbackManager.getPendingCallbacks();
      ...
      const newStats: DashboardStats = {
        ...
        activeDeals: dealBanner && dealBanner.isActive ? 1 : 0,
