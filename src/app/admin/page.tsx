    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="subtitle1" color="text.secondary">
          Manage your luxury villa rental platform - Direct Access Mode
        </Typography>
        <Alert severity="success" sx={{ mt: 2 }}>
          ✅ Authentication removed - Direct access enabled for development
        </Alert>
      </Box>
      ...
      <Box sx={{ mt: 4, textAlign: 'center' }}>
        <Typography variant="body2" color="text.secondary">
          Luxe Staycations Admin Dashboard v1.0
        </Typography>
      </Box>
    </Container>
  );
