...
export default function AdminConsultationRequestsPage() {
  ...
  // Load real-time consultation requests from ConsultationManager
  useEffect(() => {
    const loadConsultations = async () => {
      try {
        ...
        if (typeof window !== 'undefined') {
          consultationManager.initialize();
        }
        
        const allConsultations = consultationManager.getAllConsultations();
    ...
    import('@/lib/consultationManager').then(({ consultationManager }) => {
      unsubscribe = consultationManager.subscribe(() => {
        const updatedConsultations = consultationManager.getAllConsultations();
        console.log('Consultation requests updated in real-time:', updatedConsultations);
