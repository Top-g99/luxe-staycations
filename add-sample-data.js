...
async function addSampleData() {
    ...
    try {
        ...
        if (propertiesError) {
            console.log('⚠️ Properties error (might already exist):', propertiesError.message);
        } else {
        ...
        if (destinationsError) {
            console.log('⚠️ Destinations error (might already exist):', destinationsError.message);
        } else {
        ...
        if (dealBannersError) {
            console.log('⚠️ Deal banners error (might already exist):', dealBannersError.message);
        } else {
        ...
        if (heroBackgroundsError) {
            console.log('⚠️ Hero backgrounds error (might already exist):', heroBackgroundsError.message);
        } else {
